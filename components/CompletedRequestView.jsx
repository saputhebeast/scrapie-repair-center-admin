...
const CompletedRequestedView = () => {
            ...
            try {
                ...
                if (userData) {
                    ...
                    if (!repairCenterSnapshot.empty) {
                        ...
                        const data = await fetchRepairCenterRequests({ repairCenterId, status: "completed" });
    ...
    return (
        <ScrollView>
            <Text style={styles.header}>Completed Requests</Text>
...
export default CompletedRequestedView;
