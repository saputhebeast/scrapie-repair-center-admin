...
const OnGoingRequestView = () => {
            ...
            try {
                ...
                if (userData) {
                    ...
                    if (!repairCenterSnapshot.empty) {
                        ...
                        const data = await fetchRepairCenterRequests({ repairCenterId, status: "on-going" });
    ...
    return (
        <ScrollView>
            <Text style={styles.header}>On-going Requests</Text>
...
export default OnGoingRequestView;
